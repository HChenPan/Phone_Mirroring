...
public class TcpSendPCActivity extends Activity {
        ...
        switch (msg.what) {
            case HANDLER_CUT_SCRENN_SUCCESS:
                try {
                    ...
                    Toast.makeText(TcpSendPCActivity.this, "截图已保存至:sdCard/111.png", Toast.LENGTH_SHORT).show();
                } catch (FileNotFoundException e) {
                    e.printStackTrace();
                }
                break;
            case HANDLER_CONN_SUCCESS:
                Toast.makeText(TcpSendPCActivity.this, "连接成功，开始录屏", Toast.LENGTH_SHORT).show();
                break;
            default:
        }
        return false;
